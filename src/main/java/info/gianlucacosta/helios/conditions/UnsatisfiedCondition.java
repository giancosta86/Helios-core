 ...
 */
public class UnsatisfiedCondition<TSubject> implements Condition<TSubject> {
    ...
    public UnsatisfiedCondition(String message) {
    ...
    public void verify(TSubject subject) throws UnsatisfiedConditionException {
        if (message != null) {
            throw new UnsatisfiedConditionException(message);
        } else {
